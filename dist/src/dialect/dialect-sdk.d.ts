...
import { Dapps, DialectSdk as IDialectSdk, DialectSdkInfo, Messaging, Wallets, IdentityResolver, Config, TokenProvider, EncryptionKeysProvider } from '@dialectlabs/sdk';
export declare abstract class DialectSdk implements IDialectSdk<Solana> {
